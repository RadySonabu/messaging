...
SECRET_KEY = 'av9d)yf%ooarqi)_+y$p0zncng8ib42^mw+f7udi+@1i#1l8^p'
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': '##)8k3@)q5x$z@*1(yv7mp+oinp29uaza^+=3xwya11c5h9t=+',
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,

    'AUTH_HEADER_TYPES': ('Bearer',),
    'USER_ID_FIELD': 'contact_a00_rec',
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'options': '-c search_path=philthree'
        },
